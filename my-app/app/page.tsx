...
const Icons = {
  ...
  github: (props: React.SVGProps<SVGSVGElement>) => (
    ...
    >
      ...
      1.07 1.835 2.807 1.305 3.492.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 
  ...
  linkedin: (props: React.SVGProps<SVGSVGElement>) => (
    ...
    >
      ...
      1.637-1.852 3.37-1.852 3.601 0 4.268 2.368 4.268 
      5.455v6.288zM5.337 7.433c-1.144 
      0-2.067-.926-2.067-2.067 
      0-1.144.923-2.066 2.067-2.066 
      1.144 0 2.066.922 2.066 2.066 
      0 1.141-.922 2.067-2.066 
      ...
      <Dock direction="middle">
        <DockIcon>
          <a href="/" aria-label="Home">
            <Icons.home className="size-7 text-white hover:text-blue-400 transition-colors" />
          </a>
        </DockIcon>
        <DockIcon>
          <a
            href="https://github.com/Guppty"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="GitHub"
          >
            <Icons.github className="size-7 text-white hover:text-gray-400 transition-colors" />
          </a>
        </DockIcon>
        <DockIcon>
          <a
            href="https://www.linkedin.com/in/adrian-cardona/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
          >
            <Icons.linkedin className="size-7 text-white hover:text-blue-500 transition-colors" />
          </a>
        </DockIcon>
      </Dock>
    </div>
